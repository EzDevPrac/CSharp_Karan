...
namespace EShoppingWebApi.Test
{
    ...
    {
      //Act     
      var AddingRespose = _controller.AddCustomers(new Customer(){CustomerName = "@kg44",CustomerEmailId ="karan@g.com",CustomerAddress="Tamil nadu",CustomerMobileNumber="8867802650",Password="XYZ",CustomerAccountNumber="1234-1234-1234-1234"});
